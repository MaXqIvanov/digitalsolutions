    ...
    <div className={s.main}>
        <div className={s.block_user}>
            ...
            <div className={s.block_user_bottomLine}>
                <div className={s.block_user_bottomLine_main}>
            ...
            <div className={s.buttons_user}>
                <div className={s.block_user_button_write}><span>Написать сообщение</span></div>
                <div className={s.block_user_button_offer}><span>Предложить сходить на концерт</span></div>
            </div>
        </div>
        <UserPosts />
        <UserPublications />
