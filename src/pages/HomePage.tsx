    ...
    <div className={s.main}>
      <div className={s.block_img}>
        <div className={s.Title_Groups}>
          ...
          <div className={s.Title_Groups__Data}>22.03.23 в 21:00</div>
          <div className={s.back_shadow}></div>
        </div>
        <div className={s.buttons_block_img}>
          <div className={s.custom_arrow_btn_white}>
            <span className={s.arrow_img_left}></span>
          </div>
          <div className={s.custom_btn_buy_tickets_block}>
            <div className={s.custom_btn_buy_tickets}>
              <span>купить билеты</span>
            </div>
          </div>
          <div className={s.custom_arrow_btn_black}>
            <span className={s.arrow_img_right}></span>
          </div>
        </div>
      </div>
      <ViewProfile />
