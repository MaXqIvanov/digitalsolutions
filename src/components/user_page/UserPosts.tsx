...
export const UserPosts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://jsonplaceholder.typicode.com/posts?userId=${urlElelement}`)
  ...
  return (
    <div className={s.block_posts}>
      ...
      <div className={s.block_posts_post}>
        {posts ? (
          posts.map((elem: any) => (
            <div key={elem.id} className={s.templatePost}>
        ...
        <div onClick={() => navPosts(`/posts?userId=${user?.id}`)} className={s.view_allPosts}>
